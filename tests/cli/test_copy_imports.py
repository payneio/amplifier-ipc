...
def test_console_imports() -> None:
    ...
    import amplifier_ipc.cli.console as m
...
def test_key_manager_imports() -> None:
    ...
    import amplifier_ipc.cli.key_manager as m
...
def test_paths_imports() -> None:
    ...
    import amplifier_ipc.cli.paths as m
...
def test_settings_imports() -> None:
    ...
    import amplifier_ipc.cli.settings as m
...
def test_ui_display_imports() -> None:
    ...
    import amplifier_ipc.cli.ui.display as m
...
def test_ui_message_renderer_imports() -> None:
    ...
    import amplifier_ipc.cli.ui.message_renderer as m
...
def test_ui_error_display_imports() -> None:
    ...
    import amplifier_ipc.cli.ui.error_display as m
...
def test_commands_init_imports() -> None:
    ...
    import amplifier_ipc.cli.commands  # noqa: F401


def test_commands_notify_imports() -> None:
    """commands/notify.py exports notify_group."""
    import amplifier_ipc.cli.commands.notify as m
...
def test_commands_allowed_dirs_imports() -> None:
    ...
    import amplifier_ipc.cli.commands.allowed_dirs as m
...
def test_commands_denied_dirs_imports() -> None:
    ...
    import amplifier_ipc.cli.commands.denied_dirs as m
...
def test_commands_version_imports() -> None:
    ...
    import amplifier_ipc.cli.commands.version as m
...
def test_no_amplifier_lite_cli_imports_in_console() -> None:
    ...
    spec = importlib.util.find_spec("amplifier_ipc.cli.console")
...
def test_no_amplifier_lite_cli_imports_in_ui_message_renderer() -> None:
    ...
    spec = importlib.util.find_spec("amplifier_ipc.cli.ui.message_renderer")
    assert spec is not None
    source = spec.origin
    assert source is not None
    with open(source) as f:
        content = f.read()
    assert "amplifier_lite_cli" not in content
    assert "amplifier_ipc.cli.console" in content
...
def test_no_amplifier_lite_cli_imports_in_commands() -> None:
    ...
    for mod_name in [
        "amplifier_ipc.cli.commands.notify",
        "amplifier_ipc.cli.commands.allowed_dirs",
        "amplifier_ipc.cli.commands.denied_dirs",
        "amplifier_ipc.cli.commands.version",
    ]:
