...
def test_discovers_no_tools() -> None:
    """amplifier_core must report no tools (content-only service)."""
    components = scan_package("amplifier_core")
...
def test_discovers_no_hooks() -> None:
    """amplifier_core must report no hooks (content-only service)."""
    components = scan_package("amplifier_core")
...
def test_discovers_no_orchestrators() -> None:
    """amplifier_core must report no orchestrators (content-only service)."""
    components = scan_package("amplifier_core")
...
def test_discovers_no_context_managers() -> None:
    """amplifier_core must report no context_managers (content-only service)."""
    components = scan_package("amplifier_core")
...
def test_discovers_no_providers() -> None:
    """amplifier_core must report no providers (content-only service)."""
    components = scan_package("amplifier_core")
...
def test_discovers_content() -> None:
    """amplifier_core must expose at least 1 content file via scan_content."""
    paths = scan_content("amplifier_core")
