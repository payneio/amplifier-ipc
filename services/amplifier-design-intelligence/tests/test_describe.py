...
def test_discovers_no_tools() -> None:
    """amplifier_design_intelligence must report no tools (content-only service)."""
    components = scan_package("amplifier_design_intelligence")
...
def test_discovers_no_hooks() -> None:
    """amplifier_design_intelligence must report no hooks (content-only service)."""
    components = scan_package("amplifier_design_intelligence")
...
def test_discovers_no_orchestrators() -> None:
    """amplifier_design_intelligence must report no orchestrators (content-only service)."""
    components = scan_package("amplifier_design_intelligence")
...
def test_discovers_no_context_managers() -> None:
    """amplifier_design_intelligence must report no context_managers (content-only service)."""
    components = scan_package("amplifier_design_intelligence")
...
def test_discovers_no_providers() -> None:
    """amplifier_design_intelligence must report no providers (content-only service)."""
    components = scan_package("amplifier_design_intelligence")
...
def test_discovers_content() -> None:
    """amplifier_design_intelligence must expose at least 1 content file via scan_content."""
    paths = scan_content("amplifier_design_intelligence")
