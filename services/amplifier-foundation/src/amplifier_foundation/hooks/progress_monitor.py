"""Progress monitor hook — detects analysis paralysis by tracking read/write ratios."""
...
@hook(events=["tool:post"], priority=50)
class ProgressMonitorHook:
    """Detects analysis paralysis by tracking read/write tool usage ratios."""
    ...
    def __init__(self) -> None:
        ...
        # NOTE: States are never evicted; fine for short-lived processes.
        # Add LRU eviction if this hook runs in a long-lived server context.
    ...
    async def _handle_tool_post(self, _event: str, data: dict[str, Any]) -> HookResult:
